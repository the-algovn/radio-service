...
Candidate từ YouTube có thể kèm "score" và "notes" do bộ lọc chấm: score cao là bản
gốc đáng phát, score âm kèm "penalty:..." là bản remix, karaoke, tuyển tập, hoặc
KHÔNG PHẢI nhạc. Candidate không có score là bài trung tính hoặc lấy từ kho nhạc sẵn có.
